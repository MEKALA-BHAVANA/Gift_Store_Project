    	          ...
    	          <div class="card small">
    	          	<div class="card-image waves-effect waves-block waves-light">
	    			      ...
	    			      <div class="card-content card_color black-text">
        	    				<span class="card-title activator grey-text text-darken-4">Click for Details<i class="material-icons right">more_vert</i></span><br>
    			        ...
    			        <div class="card-reveal">
        						...
        						<p>
        	    				<h6 class="text-danger">RS <?php echo $row["price"];?></h6><br>
        	    				<span class="card_font"><input type="submit" class="card_button" value="Add To Cart" name="add_to_cart"></span></p>
					        </div>
    			      </div>
    		    </form>
    		  </div>
