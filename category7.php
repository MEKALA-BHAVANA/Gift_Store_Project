    		 ...
    		 <div class="col s12 l3">   
    		    <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
    	          <div class="card small">
	    			...
	    			<div class="card-content card_color black-text">
	    				<span class="card-title activator grey-text text-darken-4">Click for Details<i class="material-icons right">more_vert</i></span>
              ...
              <input type="hidden" name="item_quantity" value="1">
    			    ...
    			    <div class="card-reveal">
							...
							<p><h6 class="text-danger">RS <?php echo $row["price"];?></h6><br>
